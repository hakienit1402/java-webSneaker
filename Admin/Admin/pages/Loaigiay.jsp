                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="font-size: 25px;height: 60px">
                            <p style="width: 200px;float: left">Danh sách Admin</p>
                                ...
                                <a href="http://localhost:8080/LTWeb_war_exploded/Nhom25_WebBanGiayNam/Admin/Admin/pages/addUser.jsp"><i class="fa fa-plus" style="margin-left:20px">   New  </i> </a>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="table-responsive" style="font-size: 20px">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a href="#"><i class="fa fa-edit " style="color:green;" > Edit </i></a>
                                            <a OnClick="return confirm('Are you sure')" href="http://localhost:8080/LTWeb_war_exploded/adminXoaAD?id=<%=rs.getString(1)%>"><i class="fa fa-trash " style="color:Red;" > Delete </i></a>
