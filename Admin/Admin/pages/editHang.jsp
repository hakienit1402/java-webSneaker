...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Home > Chỉnh sửa nhà cung cấp</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row" style="margin-top: 20px">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form method="post" action="http://localhost:8080/Demo/EditHang?id=<%=rs.getString(1)%>">
                        <!-- /.panel-heading -->
                        <div class="panel-body"  >
                            ...
                            <div class="row" style="padding-top: 20px">
                                ...
                                <span class="col-lg-10">
                                    <label style="width: 500px" >
                                       <input type="file" name="logo" style="font-size: 16px ; padding-top: 10px" value="<%=rs.getString(3)%>">
                                     </label>
                            </span>
                            </div>
                            ...
                            <div class="row" style="padding-top: 20px">
                                ...
                                <span class="col-lg-10">
                                 ...
                                 <a class="btn btn-group" href="http://localhost:8080/Demo/adminHang" style="background: #f0f0f0">
                                     <i class="fa fa-close" style="font-size: 20px"> CANCEL</i></a>
                                     </span>
                            </div>
