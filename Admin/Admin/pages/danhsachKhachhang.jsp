...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Home > Khách hàng</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="font-size: 25px;height: 60px">
                            <p style="width: 200px;float: left">Danh sách</p>
                                ...
                                <a href="http://localhost:8080/Demo/Nhom25_WebBanGiayNam/Admin/Admin/pages/addKhachhang.jsp"><i class="fa fa-plus" style="margin-left:20px">   New  </i> </a>
                            ...
                            <div class="table-responsive" style="font-size: 20px">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <a href="http://localhost:8080/Demo/AdminEditKhachHang?id=<%=rs.getString(1)%>"><i class="fa fa-edit " style="color:green;" ></i></a>
                                            <a OnClick="return confirm('Are you sure')" href="http://localhost:8080/Demo/adminXoaKhachhang?id=<%=rs.getString(1)%>"><i class="fa fa-trash " style="color:Red;" ></i></a>
