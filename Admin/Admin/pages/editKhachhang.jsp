            ...
            <div class="row" style="margin-top: 20px">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form method="post" action="http://localhost:8080/Demo/AdminSua?id=<%=rs.getString(1)%>">
                        <!-- /.panel-heading -->
...
<%--                                <span class="col-lg-10">--%>
<%--                                    <label style="width: 500px" >--%>
<%--                                        <input class="form-control" name="pass" placeholder="..." value="<%=rs.getString(4)%>">--%>
<%--                                     </label>--%>
<%--                            </span>--%>
<%--                            </div>--%>
                            <div class="row" style="padding-top: 20px">
...
<%--                            </div>--%>
                            <div class="row" style="padding-top: 20px">
                                ...
                                <span class="col-lg-10">
                                 ...
                                 <a class="btn btn-group" href="http://localhost:8080/Demo/adminListKhachhang" style="background: #f0f0f0"><i class="fa fa-close" style="font-size: 20px"> CANCEL</i></a>
                                     </span>
                            </div>
