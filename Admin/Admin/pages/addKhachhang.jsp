            ...
            <div class="row" style="margin-top: 20px">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form method="post" action="http://localhost:8080/Demo/ThemKhachhang">
                        <!-- /.panel-heading -->
...
<%--                            </div>--%>
                            <div class="row" style="padding-top: 20px">
                                ...
                                <span class="col-lg-10">
                                 ...
                                 <button class="btn" type="submit"><i class="fa fa-save" style="font-size: 20px"> SAVE</i></button>
                                 <a class="btn" href="http://localhost:8080/Demo/adminListKhachhang" style="background: #f0f0f0"><i class="fa fa-close" style="font-size: 20px"> CANCEL</i></a>
                                     </span>
                            </div>
