...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Home > Danh Mục > Sản phẩm > Chỉnh sửa</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <form method="post" action="http://localhost:8080/Demo/EditSanPham?id=<%=rs.getString(1)%>">
                    <div class="panel-body"  >
                        <div class="row" style="padding-top: 20px"  >
                            ...
                            <div >
                                    Ảnh chính
                                    <input type="file" name="img1" style="font-size: 16px ; padding-top: 10px" value="<%=rs.getString(4)%>" />
                            </div>
                                </label>
                        </div>
                        <div class="row" style="padding-top: 20px">
                        ...
                        <div class="row" style="padding-top: 20px">
                            ...
                            <span class="col-lg-10">
                                    <label style="width: 500px" >
                                        <input class="form-control" name="hang" placeholder="..." value="<%=rs.getString(7)%>">
                                     </label>
                            </span>
                        </div>
                        <div class="row" style="padding-top: 20px">
                            ...
                            <span class="col-lg-10">
                                    <label style="width: 500px" >
                                        <input class="form-control" name="gia" placeholder="..." value="<%=rs.getString(3)%>">
                                     </label>
                            </span>
                        </div>
                        <div class="row" style="padding-top: 20px">
                            ...
                            <span class="col-lg-10">
                                <label style="width: 500px">
                                    <textarea class="form-control" name="mota" rows="3"  ><%=rs.getString(8)%></textarea>
                                </label>
                                     </span>
                        </div>
                        <div class="row" style="padding-top: 20px">
