...
<div class="ckeckout" style="padding: 0px;padding-top: 3px">
    <div class="container-fluid">
        ...
        <div class="ckeckout-top col-md-9">
            <div class=" cart-items heading">
                ...
                <div class="in-check" >
                    ...
                    <ul class="cart-header">
                        ...
                        <li><input style="margin-top: 33px;margin-left: 80px;width: 35px" type="number" name="soluong" value="<%=p.getSoluong()%>" min="1"></li>
            ...
            <span style="font-size: 18px;float: left">Tổng tiền:<%=c.tongtien()%>VNĐ</span>
            <a class="btn btn-info" href="http://localhost:8080/Demo/Update" style="margin-left: 260px;float: left">Update</a>
            <a class="btn btn-info" href="http://localhost:8080/Demo/HienThi" style="margin-left: 100px;float: left">Thanh toán</a>
        </div>
        </div>
    </div>
