...
<body>
<div class="shoes col-md-3 " style="background: #f8f8f8" >
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                <li>
                    <a href="http://localhost:8080/Demo/TrangChu" class="active">Trang chủ </a>
                </li>
                <li>
                ...
                <li>
                    <a href="http://localhost:8080/Demo/ListProduct?page=1">Sale<span class="fa arrow"></span></a>
