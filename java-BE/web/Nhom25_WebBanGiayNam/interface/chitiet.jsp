        ...
        <div class="single-main">
            ...
            <div class="col-12">
                ...
                <div class="details col-md-7">
                    ...
                    <div class="action"> <a href="giohang.html" target=""><button class="add-to-cart btn btn-default" type="button">MUA NGAY</button></a> <a href="" target=""><button class="like btn btn-default" type="button"><span class="fa fa-heart"></span></button>            </a>
                    </div>
                </div>
            ...
            <div class="info">
                <h3 style="color: #0b51c5">Thông tin chi tiết</h3>
                <div class="details">
                    <h5><span>- Thương hiệu: </span><span><%=rs.getString(5)%></span></h5>
                    <div class="description">
                        <h5><span><%=rs.getString(12)%></span></h5>
            ...
            <%};%>
                <div class="latest products">
                    <h3 style="color: #0b51c5"> Có thể bạn quan tâm</h3>
